/*
	This function is heavily optimized, because this might get called tens or hundreds times per frame.
*/
...
if !(params [
    ...
    diag_log "Overthrow: fn_inSpawnDistance wrong data passed!";
    false;
};
