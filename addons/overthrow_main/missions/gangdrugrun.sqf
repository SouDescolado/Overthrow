...
private _numitems = floor (2 + random 4);
private _reward = floor ((_startpos distance2D _destination) * 0.01 * _numitems);
...
[
    ...
    {
        params ["", "_gangid", "_numitems", "_reward", "_civ", "_wassuccess"];
